...
public class SceneSetup : MonoBehaviour
{
    ...
    void ValidateAndAttachScripts()
    {
        ...
        FindOrCreateGameObject("Player", obj =>
        {
            ...
            Debug.Log("PlayerController script validated and attached to Player.");
        });
    ...
    void CreateSinglePlayerMenu()
    {
        ...
        // Title
        CreateText(singlePlayerCanvas.transform, "SinglePlayerTitle", "Single Player Modes", new Vector2(0, 300), 50, FontStyle.Bold, Color.white);
